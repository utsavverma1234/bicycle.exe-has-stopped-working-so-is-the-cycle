...
opponentRed.addAnimation("opponentRed",opponentRed2Image)
  ...
  spawnObstcle3()
      ...
      if(keyDown("space")){
  bellSound.play()
opponentPink.velocityY=2;
opponentYellow.velocityY=2;
opponentRed.velocityY=2;
  }
  }
  ...
  text("PRESS SPACE TO RESTART THE GAME",100,250);
   text("TIP:-TRY PRESSING SPACE",100,300);
    text("SOMETIMES THE RACERS MAY GET OUT OF THE WAY",20,350);
  racer.addAnimation("racer",racerImage2)
  racer.velocityX=0;
